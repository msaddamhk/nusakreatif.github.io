...
@section('body')
    {{-- android --}}
    <div class="container d-block d-sm-none d-none d-sm-block d-md-none p-4" style="margin-top: 20px;margin-bottom:130px">
        <h5 style="font-weight: 600 ; font-size:22px; color:#242231">Data Pesanan</h5>
        <hr>
    ...
    {{-- android --}}
    <div class="container d-none d-md-block d-lg-nonex" style="margin-top: 140px">
